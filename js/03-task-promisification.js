...
const makeTransaction = transaction => {
    return new Promise((resolve, reject) => {
        ...
        setTimeout(() => {
            ...
            if (canProcess) {
              resolve([transaction.id, delay]); //якщо OK   !!!Resolve принимает только один параметр
              //resolve({ id: transaction.id, time: delay }); //якщо OK   !!!Resolve принимает только один параметр
